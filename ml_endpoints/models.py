...
class Endpoint(models.Model):
    ...
    owner = models.CharField(max_length=128, default='wit proj admin')
...
class MLAlgorithm(models.Model):
    ...
    '''
    name = models.CharField(max_length=128)
    description = models.CharField(max_length=1000, default='ml endpoint description default')
    code = models.CharField(max_length=50000)
    version = models.CharField(max_length=128, default='1')
    owner = models.CharField(max_length=128, default='wit proj admin')
    created_at = models.DateTimeField(auto_now_add=True, blank=True)
